...
Rectangle {
    ...
    color: {
        ...
        return Qt.rgba(Theme.surfaceContainerHigh.r, Theme.surfaceContainerHigh.g, Theme.surfaceContainerHigh.b, 0.7)
    }
        ...
        Repeater {
            ...
            Rectangle {
                ...
                DankIcon {
                    ...
                    color: isActive ? Qt.rgba(Theme.surfaceContainer.r, Theme.surfaceContainer.g, Theme.surfaceContainer.b, 0.35) : Theme.surfaceTextMedium
